...
describe('Message', function() {
  ...
  var privateKey = auroracoin.PrivateKey.fromWIF('cPBn5A4ikZvBTQ8D7NnvHZYCAxzDZ5Z2TSGW2LkyPiLxqYaJPBW4');
  ...
  it('will verify with an uncompressed pubkey', function() {
    var privateKey = new auroracoin.PrivateKey('5KYZdUEo39z3FPrtuX2QbbwGnNP5zTd7yyr2SC1j299sBCnWjss');
